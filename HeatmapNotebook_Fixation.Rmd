...
start_time <-Sys.time()
source(file=paste(getwd(),"/CleanData_FixationPoints.R", sep = ""))
source(file=paste(getwd(),"/TestingtimeonAOI2.1_FixationPointsR copy 2.R", sep = ""))
end_time <-Sys.time() 
#end_time-start_time
```
...
Heatmap8.0.R
```{r DisplayApp}
source(file=paste(getwd(),"/Heatmap8.0_FixationPoints.R", sep =""))
